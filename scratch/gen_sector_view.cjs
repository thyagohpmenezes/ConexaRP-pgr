// Generates a rich SectorAnalysisView.tsx with comparative table and bar chart
const fs = require('fs');
...
fs.writeFileSync('src/components/SectorAnalysisView.tsx', content, 'utf8');
console.log('✅ SectorAnalysisView.tsx rewritten with comparative table + bar chart');
